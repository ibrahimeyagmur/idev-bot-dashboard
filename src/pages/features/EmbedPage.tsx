  ...
  const features = [
    {
      ...
      description: "Sürükle-bırak ile embed oluşturun.",
    },
    {
      icon: Palette,
      title: "Renk Özelleştirme",
      description: "Embed renklerini markanıza uygun yapın.",
    },
    {
      icon: Image,
      title: "Medya Desteği",
      description: "Resim ve thumbnail ekleyin.",
    },
    {
      icon: Clock,
      title: "Zamanlanmış Gönderim",
      description: "Embedleri otomatik gönderin.",
    },
    {
      icon: Save,
      title: "Şablonlar",
      description: "Sık kullandığınız embedleri kaydedin.",
    },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-slate-400 mb-8">
              Profesyonel görünümlü embed mesajlar oluşturun ve sunucunuzu
              güzelleştirin.
            </p>
