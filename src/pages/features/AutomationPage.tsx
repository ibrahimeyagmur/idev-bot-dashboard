  ...
  const features = [
    {
      ...
      description: "Discord davetlerini ve linkleri otomatik engelleyin.",
    },
    {
      icon: Filter,
      title: "Küfür Filtresi",
      description: "Uygunsuz kelimeleri otomatik tespit edin ve silin.",
    },
    {
      icon: Settings,
      title: "Özel Kurallar",
      description: "Kanal ve rol istisnalarını ayarlayın.",
    },
    {
      icon: UserX,
      title: "Otomatik Eylemler",
      description: "Mesaj silme, uyarı veya zaman aşımı.",
    },
  ];
            ...
            <div className="p-6 space-y-4">
              <div className="bg-[#12131a] rounded-lg p-4 opacity-50 relative">
                ...
                <p className="text-slate-300 text-sm line-through">
                  Herkese merhaba! discord.gg/xxx sunucumuza katılın!
                </p>
              </div>
              ...
              <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    discord.gg/xxx linki tespit edildi ve silindi
                  </p>
                </div>
              </div>
              ...
              <div className="bg-orange-500/10 border border-orange-500/20 rounded-lg p-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    Uygunsuz kelime tespit edildi ve silindi
                  </p>
                </div>
              </div>
            </div>
