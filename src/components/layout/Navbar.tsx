...
import { Menu, X, ChevronDown, Sparkles, BookOpen, LayoutDashboard, LogOut } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-white font-[var(--font-heading)]">IDev</span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            >
              ...
              >
                ...
                Özellikler
                <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${openDropdown === 'features' ? 'rotate-180' : ''}`} />
              </button>
            ...
            {isLoggedIn && user ? (
              <div className="relative">
                ...
                >
                  ...
                  <ChevronDown className={`w-4 h-4 text-slate-400 transition-transform duration-200 ${openDropdown === 'user' ? 'rotate-180' : ''}`} />
                </button>
                {openDropdown === 'user' && (
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-[#171821] border-t border-white/5">
          <div className="px-4 py-4 space-y-2">
            ...
            <div>
              <button
                onClick={() => setOpenDropdown(openDropdown === 'features-mobile' ? null : 'features-mobile')}
              ...
              >
                ...
                <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${openDropdown === 'features-mobile' ? 'rotate-180' : ''}`} />
              </button>
            ...
            <div>
              ...
              >
                ...
                <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${openDropdown === 'resources-mobile' ? 'rotate-180' : ''}`} />
              </button>
              ...
              {isLoggedIn && user ? (
                <>
                  <div className="flex items-center gap-2 px-3 py-2 mb-2">
                    <img src={user.avatarUrl} alt={user.name} className="w-8 h-8 rounded-full ring-2 ring-[#675de6]/50" />
                    <span className="text-sm text-slate-200 font-medium">{user.name}</span>
                  </div>
                  <Link
                    to="/dashboard"
