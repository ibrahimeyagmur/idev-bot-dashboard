          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400">
                  Üyeler mesaj attıkça XP kazanır ve seviye atlar
                </p>
              </div>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                onChange={(e) =>
                  setLevelData({ ...levelData, enabled: e.target.checked })
                }
          ...
          <div className="p-6 space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="flex items-center gap-4">
                  <input
                    ...
                    onChange={(e) =>
                      setLevelData({
                        ...levelData,
                        xpPerMessage: parseInt(e.target.value),
                      })
                    }
                ...
                <p className="text-xs text-slate-500 mt-1">
                  Her mesaj için kazanılacak XP miktarı
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-1">
                  Mesajlar arası minimum bekleme süresi
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setLevelData({ ...levelData, levelUpMessage: e.target.value })
                }
                rows={2}
                ...
                {["{user}", "{level}", "{xp}"].map((tag) => (
                  <button
                    ...
                    onClick={() =>
                      setLevelData({
                        ...levelData,
                        levelUpMessage: levelData.levelUpMessage + " " + tag,
                      })
                    }
              ...
              {levelData.roles.length === 0 ? (
                <div className="text-center py-8 bg-[#12131a] rounded-lg border border-dashed border-white/10">
                  ...
                  <p className="text-slate-500 text-xs mt-1">
                    Belirli seviyelerde otomatik rol verilebilir
                  </p>
                </div>
              ) : (
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                ...
                <div>
                  <div className="text-2xl font-bold text-purple-400">
                    {Math.round(
                      calculateXpForLevel(5) / levelData.xpPerMessage
                    )}
                  </div>
