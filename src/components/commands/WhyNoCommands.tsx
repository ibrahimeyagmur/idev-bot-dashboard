...
const reasons = [
  {
    ...
    description:
      "Komut ezberlemeye gerek yok. Panelden birkaç tıkla her şeyi ayarla.",
    color: "#f59e0b",
  },
  {
    icon: ShieldCheck,
    title: "Daha Az Hata",
    description:
      "Yanlış yazım, eksik parametre derdi yok. Görsel arayüzle hatasız yapılandırma.",
    color: "#22c55e",
  },
  {
    icon: Users,
    ...
    description:
      "Teknik bilgi gerektirmez. Sunucu yöneticileri kolayca kullanabilir.",
    color: "#675de6",
  },
];
