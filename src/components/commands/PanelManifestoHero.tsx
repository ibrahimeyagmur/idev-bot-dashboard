      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              IDev'de slash/prefix komutlarla uğraşmazsın. Tüm sistemler web panelde: 
              karşılama, seviye, embed, tepki rolleri, otomatik moderasyon ve otomatik cevaplar.
            </motion.p>
          ...
          {/* Right Content - Panel Preview Mock */}
          <motion.div
            ...
            <div className="relative">
              ...
              <div className="relative bg-[#171821] rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
                ...
                <div className="flex items-center gap-2 px-4 py-3 border-b border-white/10 bg-[#12131a]">
                  ...
                  <span className="ml-3 text-xs text-slate-500">IDev Dashboard</span>
                </div>
                ...
                <div className="p-6 space-y-4">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-white">Karşılama Sistemi</p>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="p-3 bg-white/5 rounded-lg border border-white/5">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-xs text-slate-400">Engellenen</span>
                      </div>
                  ...
                  <div className="p-4 bg-[#12131a] rounded-lg border-l-4 border-[#675de6]">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-sm font-medium text-[#675de6]">Embed Önizleme</span>
                    </div>
                    <p className="text-xs text-slate-400">Hoş geldin mesajı hazır!</p>
                  </div>
