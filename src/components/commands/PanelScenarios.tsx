                  ...
                  >
                    {activeScenario.preview.type === "welcome" && (
                      <div className="space-y-3">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <span className="font-medium text-[#675de6]">
                              IDev Bot
                            </span>
                        ...
                        <div
                          className="ml-12 p-4 bg-[#12131a] rounded-lg border-l-4"
                          style={{ borderColor: activeScenario.color }}
                        >
                          <p className="text-slate-300">
                            {activeScenario.preview.content}
                          </p>
                        </div>
                      </div>
                    )}
                    ...
                    {activeScenario.preview.type === "autoreply" && (
                      <div className="space-y-3">
                        ...
                        <p className="ml-10 text-slate-300 text-sm">
                          {activeScenario.preview.keyword}
                        </p>
                        ...
                        <div className="flex items-center gap-2 mt-4">
                          ...
                          <div>
                            <span className="font-medium text-[#675de6] text-sm">
                              IDev Bot
                            </span>
                        ...
                        <p className="ml-10 text-slate-300 text-sm">
                          {activeScenario.preview.response}
                        </p>
                      </div>
                    )}
                      ...
                      <div className="space-y-3">
                        ...
                        >
                          <h4 className="font-semibold text-white mb-1">
                            {activeScenario.preview.title}
                          </h4>
                          <p className="text-slate-400 text-sm">
                            {activeScenario.preview.description}
                          </p>
                          <div className="mt-3 pt-3 border-t border-white/10">
                            <p className="text-xs text-slate-500">
                              IDev Bot • Bugün 15:30
                            </p>
                          </div>
                        </div>
                      </div>
