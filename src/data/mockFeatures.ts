...
export const features: Feature[] = [
  {
    ...
    description:
      "Yeni üyeleri özel mesajlarla karşılayın ve onları topluluğunuza dahil edin.",
    icon: MessageSquare,
...
export const mockFAQ = [
  {
    ...
    answer:
      "Discord'a Ekle butonuna tıklayarak botu sunucunuza ekleyebilirsiniz. Her şey ücretsiz!",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Discord destek sunucumuza katılarak 7/24 destek alabilirsiniz. Her şey ücretsiz.",
  },
  {
    question: "Verilerim güvende mi?",
    answer:
      "Evet, verileriniz şifreli olarak saklanır ve üçüncü taraflarla paylaşılmaz. Her şey ücretsiz.",
  },
];
